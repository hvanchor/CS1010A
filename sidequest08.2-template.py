...
def get_birthday(possible_birthdays):
    statement1_result = tuple(filter(lambda x: statement1(x, possible_birthdays), possible_birthdays))
    statement2_result = tuple(filter(lambda x: statement2(x, statement1_result), statement1_result))
    return tuple(filter(lambda x: statement3(x, statement2_result), statement2_result))
