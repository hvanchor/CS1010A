...
your_AI = Ernesto_AI # Modify if you changed the name of the AI class
...
# Replace gui=True with gui=False if you do not wish to see the GUI
#simulation.task2(your_AI("XX AI", 100), time_limit, gui=True)
